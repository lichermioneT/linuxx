...
{ 
    ...
    std::unique_ptr<Thread> Thread2(new Thread(getTicket,(void*)"hello lic1", 2));
    std::unique_ptr<Thread> Thread3(new Thread(getTicket,(void*)"hello lic1", 3));
    std::unique_ptr<Thread> Thread4(new Thread(getTicket,(void*)"hello lic1", 4));
