...
namespace server
{
    ...
    public:
        ...
        void initServer()
        {
            ...
            logMessage(NORMAL, "create socket success %d", getpid());
        ...
        void start()
        {
            ...
            for (;;)
            {
                ...
                logMessage(NORMAL, "accept a new link success");
                logMessage(NORMAL, "accept a new link success");
                logMessage(DEBUG,  "accept a new link success");
                logMessage(NORMAL, "accept a new link success");
                ...
                // close(sock); // 关闭父进程的文件呢描述符
                // demo4
                // pthread_t tid = 0;
                // ThreadData* td = new ThreadData(this, sock);
                // pthread_create(&tid, nullptr, threadRoutine, td); // 能够看到组长的文件描述符，不需要像进程一样关闭文件描述符。
                // demo5;
