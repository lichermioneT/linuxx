...
**描述的本质就是对一个对象进行管理。组织就是对多个对象进行管理的。**
...
**并行：多个CPU执行，多个 进程。  一个计算机 运行多个进程。 CPU的核数。**
...
| 概念   | 含义                                         |
| ------ | -------------------------------------------- |
| 核心数 | CPU 里真正的物理计算核心数量                 |
| 线程数 | CPU 通过超线程技术暴露出来的逻辑执行单元数量 |

**CPU任何一个时刻只能执行一个进程。**

**CPU 核数表示 CPU 里面有多少个物理计算核心；核心越多，越适合同时运行多个任务或多线程程序，但单线程程序不一定能充分利用多个核心。**
...
![image-20260421091950482](picture/image-20260421091950482.png)
...
![image-20260421093540237](picture/image-20260421093540237.png)
...
![image-20260421093935874](picture/image-20260421093935874.png)
...
![image-20260421094305105](picture/image-20260421094305105.png)



**fork函数的问题**

![image-20260421094758308](picture/image-20260421094758308.png)
...
![image-20260421094619097](picture/image-20260421094619097.png)
