...
**linux实现线程是：操作系统是实现一个task_struct。linux原生线程库实现一部分的。**
...
**一个线程默认是 joinable, detach之后就不可以进行join了。**



**线程：是建立一个自己的独立栈帧。建立栈帧需要花费时间的。**
...
**线程的分离 最好是主线程之外， 子线程里面分离 可能 主线程已经在 join了。**
...
![image-20260409080150376](picture/image-20260409080150376.png)
...
![image-20260409090241546](picture/image-20260409090241546.png)
...
**全局没有保护的时候，往往是不安全的。多个线程切换，会造成数据不一致的问题。**
...
**lock 和  unlock之间的临界资源，会被执行完了，才被切换的。**
...
![image-20260409135449048](picture/image-20260409135449048.png)
...
![image-20260409112416056](picture/image-20260409112416056.png)
...
![image-20260409140546062](picture/image-20260409140546062.png)

![image-20251203202118291](picture/image-20251203202118291.png)

![image-20260409140908436](picture/image-20260409140908436.png)
...
![image-20260409142027210](picture/image-20260409142027210.png)

死锁

![image-20260409142619915](picture/image-20260409142619915.png)
...
**判断：条件不满足的时候，不再申请，将自己挂起。**



**理解条件变量。**

**条件不满足的时候，必须去某些定义好的条件变量上进行 等待。**
...
![image-20260410102356262](picture/image-20260410102356262.png)

![image-20260411161943808](picture/image-20260411161943808.png)
...
![image-20260410105625250](picture/image-20260410105625250.png)



**锁的存在，任何 时刻只能有一个执行流在里面执行。**
...
**sem--; --申请资源   必须保证操作的原子性  --p操作  申请一份资源，资源就变少了的**

**sem++; ++归还资源   必须保证操作的原子性  --v操作 归还一份资源**
